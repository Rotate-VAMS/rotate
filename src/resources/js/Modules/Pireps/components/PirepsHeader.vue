<template>
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 sm:mb-6 gap-3 sm:gap-0">
      <div class="w-full sm:w-auto">
        <h1 class="text-2xl sm:text-3xl font-bold text-gray-800">View Pireps</h1>
        <p class="text-xs sm:text-sm text-gray-500 mt-1">View and manage all pireps in your airline. Monitor performance, track progress, and oversee pireps operations.</p>
      </div>
      <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 w-full sm:w-auto mt-2 sm:mt-0" v-if="user.permissions.includes('create-pirep')">
        <button 
