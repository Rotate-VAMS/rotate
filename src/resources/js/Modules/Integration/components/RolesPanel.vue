<template>
  <div class="max-w-4xl mx-auto p-4 sm:p-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
      <div class="flex items-center gap-3 mb-4 sm:mb-0">
        ...
        <div>
          <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Roles</h1>
          <p class="text-gray-600 text-sm sm:text-base">Manage your roles and their permissions</p>
        </div>
      </div>
  ...
  import { PlusIcon, EditIcon, TrashIcon, SettingsIcon, UsersIcon } from 'lucide-vue-next'
